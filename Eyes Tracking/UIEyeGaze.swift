...
class UIEyeGaze: UITouch {
    ...
    override public var description: String {
            return """
        UIEyeGazeEvent: position in NDC: \(_position), previous position in NDC \(_previousPosition), receiver: \(_receiver), window: \(String(describing: _window))
        """
    }
